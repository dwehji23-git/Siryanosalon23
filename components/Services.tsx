...
const categories: Category[] = [
  {
    ...
    icon: Scissors,
    services: [
      { name: "Haircut - Washing - Style", price: 70, duration: "30 min" },
      { name: "Skin Fade - Washing - Style", price: 80, duration: "45 min", tag: "Popular" },
      { name: "High or Low Taper Fade Haircut", price: 80, duration: "45 min" },
      { name: "Haircut Machine", price: 60, duration: "25 min" },
      { name: "Hair Style", price: 45, duration: "20 min" },
      { name: "Children Hair Cut with Wash & Style", price: 57, duration: "30 min" },
    ],
  },
  {
    label: "Beard & Shave",
    icon: Drop,
    services: [
      { name: "Regular Shave", price: 45, duration: "20 min" },
      { name: "Special Shave", price: 60, duration: "30 min" },
      { name: "Beard Shave", price: 57, duration: "20 min" },
      { name: "Special Beard Shave With Scissors", price: 66, duration: "30 min" },
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Hair Treatment (Caviar)", price: 99, duration: "60 min" },
      { name: "Hair Treatment (Caviar) - Special", price: 149, duration: "30 min", tag: "Offer" },
      { name: "Keratin Treatment", price: 350, duration: "40 min - 2 hr" },
      { name: "BTX Keratin", price: 350, duration: "40 min" },
      { name: "Hair Keratin", price: 499, duration: "60 min", tag: "Premium" },
      { name: "Schwarzkopf Treatment", price: 150, duration: "1 hr" },
      { name: "Schwarzkopf Bonacure", price: 199, duration: "1 hr" },
      { name: "Hot Oil Treatment", price: 114, duration: "1 hr" },
    ],
  },
  {
    label: "Facials & Skin",
    ...
    services: [
      ...
      { name: "Scrub Face", price: 47, duration: "25 min" },
      ...
      { name: "Signature Facial", price: 349, duration: "60 min", tag: "Most Popular" },
      { name: "Ocean Oil Facial", price: 250, duration: "60 min" },
      { name: "Brightening Facial", price: 300, duration: "60 min" },
      { name: "Hydra Specula Facial", price: 350, duration: "60 min" },
      { name: "Anti Aging Treatment", price: 333, duration: "1 hr" },
      { name: "Hyaluronic Special Facial", price: 238, duration: "1 hr" },
      { name: "Acne Facial", price: 285, duration: "1 hr" },
    ],
  },
  {
    label: "Massage & Spa",
    icon: Wind,
    services: [
      { name: "Massage", price: 209, duration: "1 hr" },
      { name: "Relaxing Massage", price: 200, duration: "1 hr" },
      { name: "Chair Massage", price: 71, duration: "30 min" },
      { name: "Foot Massage", price: 95, duration: "30 min - 1 hr" },
      { name: "Moroccan Bath", price: 209, duration: "1 hr" },
      { name: "Moroccan Bath + Body Scrub", price: 200, duration: "55 min" },
      { name: "Moroccan Bath + Scrub & Massage", price: 350, duration: "1 hr 30 min", tag: "Premium" },
      { name: "Scrub & Mask", price: 71, duration: "30 min" },
    ],
  },
  {
    label: "Nail Care",
    ...
    services: [
      ...
      { name: "Pedicure", price: 60, duration: "20 min" },
      { name: "SPA Pedicure", price: 66, duration: "30 min - 1 hr" },
      { name: "Pedi-Scrub", price: 40, duration: "20 min" },
      { name: "Foot Scrub", price: 38, duration: "30 min" },
      { name: "Manicure + Pedicure & Scrub", price: 120, duration: "50 min" },
      { name: "Manicure + Pedicure with Scrub", price: 161, duration: "1 hr 15 min" },
    ],
  },
  {
    label: "Waxing & Body",
    icon: Flame,
    services: [
      { name: "Full Face Wax Or Threading", price: 23, duration: "10 min" },
      { name: "Half Arm Waxing", price: 47, duration: "30 min" },
      { name: "Chest Shaving", price: 57, duration: "30 min" },
      { name: "Back Shaving", price: 57, duration: "25 min" },
      { name: "Full Body Shaving With Razor", price: 300, duration: "1 hr", tag: "Premium" },
      { name: "Nose & Ear Wax", price: 28, duration: "10 min" },
